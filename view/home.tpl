...
<section class="hero-section">
    <div class="hero-items owl-carousel">
        <div class="single-hero-items set-bg" data-setbg="{$GET_TEMA}/img/hero-1.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5">
                        <span>Bag,kids</span>
        ...
        <div class="single-hero-items set-bg" data-setbg="{$GET_TEMA}/img/hero-2.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5">
                        <span>Bag,kids</span>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="single-banner">
                    <img src="{$GET_TEMA}/img/banner-1.jpg" alt="">
