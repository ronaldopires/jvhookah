...
<section class="hero-section">
    <div class="hero-items owl-carousel">
        <div class="single-hero-items set-bg" data-setbg="{$GET_TEMA}/img/home1.jpg">
            <!-- <div class="container">
                <div class="row">
                    <div class="col-lg-5">
                        <span>Bag,kids</span>
        ...
        <div class="single-hero-items set-bg" data-setbg="{$GET_TEMA}/img/home2.jpg">
            <!-- <div class="container">
                <div class="row">
                    <div class="col-lg-5">
                        <span>Bag,kids</span>
        ...
        <div class="single-hero-items set-bg" data-setbg="{$GET_TEMA}/img/home3.jpg">
            <!-- <div class="container">
                <div class="row">
                    <div class="col-lg-5">
                        <span>Bag,kids</span>
            ...
            <div class="col-lg-8 offset-lg-1">
                <div class="filter-control">
                    <ul>
                        ...
                        <li class="active">{$C.cate_nome}</li>
                        <!-- <li>{$C.cate_nome}</li> -->
                        {/foreach}
                    </ul>
                </div>
...
<section class="deal-of-week set-bg spad" data-setbg="{$GET_TEMA}/img/time-bg.jpg">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="product-slider owl-carousel">
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="{$GET_TEMA}/img/products/man-1.jpg" alt="">
                            <div class="sale">Sale</div>
                            <div class="icon">
                                <i class="icon_heart_alt"></i>
                            </div>
                    ...
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="{$GET_TEMA}/img/products/man-2.jpg" alt="">
                            <div class="icon">
                                <i class="icon_heart_alt"></i>
                            </div>
                            <ul>
                    ...
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="{$GET_TEMA}/img/products/man-3.jpg" alt="">
                            <div class="icon">
                                <i class="icon_heart_alt"></i>
                            </div>
                            <ul>
                    ...
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="{$GET_TEMA}/img/products/man-4.jpg" alt="">
                            <div class="icon">
                                <i class="icon_heart_alt"></i>
                            </div>
                            <ul>
            ...
            <div class="col-lg-3 offset-lg-1">
                <div class="product-large set-bg m-large" data-setbg="{$GET_TEMA}/img/products/man-large.jpg">
                    <h2>Men’s</h2>
                    <a href="#">Discover More</a>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="single-latest-blog">
                    <img src="{$GET_TEMA}/img/latest-1.jpg" alt="">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-latest-blog">
                    <img src="{$GET_TEMA}/img/latest-2.jpg" alt="">
                    <div class="latest-text">
                        <div class="tag-list">
                            <div class="tag-item">
                                <i class="fa fa-calendar-o"></i> May 4,2019
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-latest-blog">
                    <img src="{$GET_TEMA}/img/latest-3.jpg" alt="">
                    <div class="latest-text">
                        <div class="tag-list">
                            <div class="tag-item">
                                <i class="fa fa-calendar-o"></i> May 4,2019
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="single-benefit">
                        <div class="sb-icon">
                            <img src="{$GET_TEMA}/img/icon-1.png" alt="">
                        </div>
                        <div class="sb-text">
                            <h6>Free Shipping</h6>
                ...
                <div class="col-lg-4">
                    <div class="single-benefit">
                        <div class="sb-icon">
                            <img src="{$GET_TEMA}/img/icon-2.png" alt="">
                        </div>
                        <div class="sb-text">
