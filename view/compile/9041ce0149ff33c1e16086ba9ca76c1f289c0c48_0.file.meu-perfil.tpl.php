<?php
/* Smarty version 3.1.36, created on 2020-10-08 16:37:41
  from 'C:\xampp\htdocs\jvhookah\view\meu-perfil.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_5f7f6a856e33c3_35597404',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9041ce0149ff33c1e16086ba9ca76c1f289c0c48' => 
    array (
      0 => 'C:\\xampp\\htdocs\\jvhookah\\view\\meu-perfil.tpl',
      1 => 1602185859,
      2 => 'file',
    ),
  ),
...
function content_5f7f6a856e33c3_35597404 (Smarty_Internal_Template $_smarty_tpl) {
                ...
                <nav class="navbar navbar-expand-md navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="menu_perfil">
                        <div class="nav w-100 flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link" href="<?php echo $_smarty_tpl->tpl_vars['PAG_LOGOUT']->value;?>
...
?>
                                    <tr>
                                        ...
                                        <td class="align-middle d-xs-none"><?php echo $_smarty_tpl->tpl_vars['P']->value['ped_ref'];?>
</td>
                                        <td class="align-middle"><?php echo $_smarty_tpl->tpl_vars['P']->value['ped_pag_status'];?>
</td>
                                        <td>
                                            <form method="POST" action="<?php echo $_smarty_tpl->tpl_vars['PAG_DETALHES_PEDIDOS']->value;?>
">
...
, <strong>Estado:</strong> <?php echo $_smarty_tpl->tpl_vars['E']->value['endereco_cli_uf'];?>
 - <strong>Complemento:</strong> <?php echo $_smarty_tpl->tpl_vars['E']->value['endereco_cli_complemento'];?>
                                        ...
                                        <button type="button" class="site-btn btn-block mb-3" data-toggle="modal" data-target="#endereco<?php echo $_smarty_tpl->tpl_vars['E']->value['endereco_id'];?>
">
                                            <i class="ti-pencil-alt mr-2"></i> Editar
                                          </button>
                                        <button class="site-btn-danger btn-block" type="button" data-toggle="modal" data-target="#deletar<?php echo $_smarty_tpl->tpl_vars['E']->value['endereco_id'];?>
"><i class="ti-trash mr-2"></i>Deletar</button>
                                        <div class="modal fade" id="deletar<?php echo $_smarty_tpl->tpl_vars['E']->value['endereco_id'];?>
" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="modalOthersAddress" aria-hidden="true">
                                            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                                <div class="modal-content register-form">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form method="POST">
                                                            <input type="hidden" name="deletar_outro_endereco" value="<?php echo $_smarty_tpl->tpl_vars['E']->value['endereco_id'];?>
">
                                    ...
                                    <div class="modal fade" id="endereco<?php echo $_smarty_tpl->tpl_vars['E']->value['endereco_id'];?>
                                                ...
                                                <form method="POST" class="formEditarOutroEndereco">
                                                    <div class="modal-body">
                                                        <div class="col">
                                                            <div class="form-row">
                                                                <div class="form-group group-input col-md-12">
                                                                    <input type="hidden" name="endereco_id" value="<?php echo $_smarty_tpl->tpl_vars['E']->value['endereco_id'];?>
">
                                                                    <label for="endereco_cli_endereco">Rua</label>
                                                                    <input type="text" name="endereco_cli_endereco" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['E']->value['endereco_cli_endereco'];?>
" required>
                                                                </div>
                                                                <div class="form-group group-input col-md-12">
                                                                    <label for="endereco_cli_bairro">Bairro</label>
                                                                    <input type="text" name="endereco_cli_bairro" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['E']->value['endereco_cli_bairro'];?>
" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-row">
                                                                <div class="form-group group-input col-md-6">
                                                                    ...
                                                                    <input type="text" class="form-control" name="endereco_cli_numero" value="<?php echo $_smarty_tpl->tpl_vars['E']->value['endereco_cli_numero'];?>
" required>
                                                                </div>
                                                                <div class="form-group group-input col-md-6">
                                                                    <label for="endereco_cli_cep">CEP</label>
                                                                    <input type="text" class="form-control" name="endereco_cli_cep" value="<?php echo $_smarty_tpl->tpl_vars['E']->value['endereco_cli_cep'];?>
" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-row">
                                                                <div class="form-group group-input col-md-6">
                                                                    ...
                                                                    <input type="text" class="form-control" name="endereco_cli_cidade" value="<?php echo $_smarty_tpl->tpl_vars['E']->value['endereco_cli_cidade'];?>
" required>
                                                                </div>
                                                                <div class="form-group group-input col-md-6">
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-group group-input col-md-12">
                                                                    ...
                                                                    <input type="text" class="form-control" name="endereco_cli_complemento" value="<?php echo $_smarty_tpl->tpl_vars['E']->value['endereco_cli_complemento'];?>
">
                                                                </div>
                                                            </div>
                                                        </div>
