<?php
/* Smarty version 3.1.36, created on 2020-06-11 06:30:17
  from 'C:\xampp\htdocs\jvhookah\view\meu_perfil.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_5ee1f9a9babaa0_19466397',
...
function content_5ee1f9a9babaa0_19466397 (Smarty_Internal_Template $_smarty_tpl) {
...
"><i class="ti-power-off mr-2"></i> Sair</a>
            ...
            <div class="col-lg-9 col-md-9 p-3 border">
                            ...
                            <table class="table">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th scope="col" class="d-sm-none d-md-block d-xs-none">Ref</th>
...
?>
                                    <tr>
                                        ...
                                        <td class="d-sm-none d-md-block d-xs-none"><?php echo $_smarty_tpl->tpl_vars['P']->value['ped_ref'];?>
</td>
...
" readonly>
                                    ...
                                    <div class="form-row justify-content-center py-3" id="divBtnSave">
                                        <button id="btnSaveDadosCli" class="site-btn col-2 mr-3">Salvar</button>
                                        <button id="btnCancelDadosCli" type="reset" class="site-btn-danger col-2">Cancelar</button>
                                    </div>
                                </form>
                            </div>
                        </div>
