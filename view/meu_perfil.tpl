                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{$P.ped_hora}</td>
                                        <td class="d-sm-none d-md-block d-xs-none">{$P.ped_ref}</td>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12">
                                <div class="card m-0">
                                    <div class="card-body">
                                        ...
                                        <div class="modal fade" id="deletar{$E.endereco_id}" tabindex="-1" role="dialog" aria-labelledby="modalOthersAddress" aria-hidden="true">
                                            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                                <div class="modal-content register-form">
                                                    <div class="modal-header">
