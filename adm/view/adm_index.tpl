...
<head>
    ...
    <!-- Chart -->
    <script src="{$GET_TEMA}/tema/js/Chart.min.js"></script>

    <!-- Custom fonts for this template-->
    <!-- <link rel="stylesheet" href="{$GET_TEMA}/tema/css/all.min.css" type="text/css"> -->
    ...
    <link rel="stylesheet" href="{$GET_TEMA}/tema/css/sb-admin-2.min.css" type="text/css">
    <link rel="stylesheet" href="{$GET_TEMA}/tema/css/style-adm.css" type="text/css">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{$PAG_HOME}">
            ...
            <li class="nav-item">
                ...
                <div id="collapseProducts" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{$PAG_PRODUTOS}">Produtos</a>
                        <a class="collapse-item" href="{$PAG_ADICIONAR_PRODUTO}">Adicionar</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePedidos" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{$PAG_PEDIDOS}">Todos</a>
...
<span aria-hidden="true">×</span>
    ...
    <script src="{$GET_TEMA}/tema/js/bootstrap.bundle.min.js"></script>
    <script src="{$GET_TEMA}/tema/js/sb-admin-2.min.js"></script>
    <script src="{$GET_TEMA}/tema/js/script.js"></script>
    <script src="{$GET_TEMA}/tema/chartsAdm/chart-area-demo.js"></script>
